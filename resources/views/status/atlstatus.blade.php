      ...
      <ul class="d-flex calculatorul " style="list-style-type: none;">
        ...
        <li class=" spacebetweenli">
          <a href="atlstatus" class="hoverimageslink">
            <img src="{{asset('images/hoverimages/atlhover.png')}}" onmouseleave="atlhoveronmouseleave()" onmouseenter="atlhoveronmouseenter()" class="calculatorstatusimage  " id="atl" alt="ntn">
...
<form action="">
<label for="" class="form-label">ATL STATUS FINDER</label>
  <ul class="d-block d-lg-flex finder-search">
...
<div class="row mt-5 ">
  <div class="col-12 ">
    <h2 ><span class="atl-blur-heading">Discover our</span> <span class="video-dark-heading">video content</span></h2>
    
    <p class="atl-description">We would love to show you, how simple and friendly Befiler we have made it for you with the help of industry's best experts, as they know everything about taxes.</p>
  </div>
</div>
<!-- row end -->
